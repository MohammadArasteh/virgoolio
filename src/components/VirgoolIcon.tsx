const VirgoolIcon = () => (
  <svg width="35px" height="50px" viewBox="0 0 204 304">
    ...
    >
      <stop offset="0" className="page_speed_374966583"></stop>
      <stop offset="1" className="page_speed_515658119"></stop>
    </linearGradient>
    <path
      id="Shape"
      fill="rgb(16, 122, 190)"
    ...
    >
      <g filter="url(#filter-3)" className="st1">
        <path
          id="path-2_2_"
